...
def tf_idf(training_data, test_data):
    '''Utilises Sklearn's TdidfVectorizer to create a TD-IDF matrix for the
    documents provided.

    Inputs:
    * training_data - this should be the column either the cleaned review or
    the original review from the DF
    * test_data - this should be the column either the cleaned review or the
    original review from the DF
...
def BagOfWords(training_data, test_data):
    ...
    * test_data - this should be the column either the cleaned review or the
    ...
    Outputs:
    * BOW_Training - Dataframe containing Bag Of Words for the Training
    dataframe provided
...
def n_gram(n_value: int, training_data, test_data):
    '''Allows the user to be able to input the n-value and returns n_grams of
    ONLY that value
    ...
    * test_data - this should be the column either the cleaned review or the
    ...
    Outputs:
    * ngram_Training - Dataframe containing ngrams for the Training dataframe
    provided
